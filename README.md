...
1. **Information Retrieval** – finding relevant document content using vector similarity
2. **Answer Generation** – forming answers using the retrieved context
...
### Backend
```bash
>>>>>>> cd2e05d3be4bf50ec9e8b62dd3d5e5fddb23a522
cd backend
python -m venv venv
